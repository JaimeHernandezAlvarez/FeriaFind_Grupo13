...
class SellersViewModel(
    ...
    //instanciamos el Repositorio que creamos antes
    ...
    // --- CRUD ---
    fun crearVendedor(vendedor: Vendedor) {
        viewModelScope.launch {
            repository.createVendedor(vendedor)
            fetchVendedores()
        }
    }
    ...
    fun actualizarVendedor(vendedor: Vendedor) {
        viewModelScope.launch {
            repository.updateVendedor(vendedor)
            fetchVendedores()
        }
    }

    fun eliminarVendedor(id: String) {
        viewModelScope.launch {
